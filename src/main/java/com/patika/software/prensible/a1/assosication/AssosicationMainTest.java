...
public class AssosicationMainTest {
    public static void main(String[] args) {
        Musteri musteri=Musteri.builder().musteriAdi("Beytullah").musteriSehir("Samsun").build();

        SuperMarket superMarket=SuperMarket.builder().superMarketAdi("ABC").superMarketSehir("Samsun").build();
